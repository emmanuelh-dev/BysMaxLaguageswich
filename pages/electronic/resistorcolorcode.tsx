...
const OhmLawCalculator: NextPage = () => {
  ...
  return (
    ...
    <h1 className="text-5xl font-semibold mb-4">Ohm&rsquo;s Law Calculator</h1>
    <div className="mb-4">
      <p className="text-xl mb-2">
        Enter any two values (voltage, current, resistance or power) and click the &rsquo;Calculate&rsquo; button to calculate the other two values.
      </p>
      <p className="text-xl">
        Note: Use the correct units (volts for voltage, amps for current, ohms for resistance, and watts for power).
      </p>
    </div>
    <div className="mb-4">
      <p className="text-xl mb-2">
        Ohm&rsquo;s Law states that the current through a conductor between two points is directly proportional to the voltage across the two points.
      </p>
      <p className="text-xl">
    ...
    <div className="mb-4">
      ...
      <button
        className={classNames(
          ...
          { 'opacity-50 cursor-not-allowed': !voltage && !current && !resistance && !power }
        )}
