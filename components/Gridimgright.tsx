...
const Gridimgright: FC<LayoutProps> = ({ title, description, link, image }) => {
  return (
    <>
      <div className="md:grid md:grid-cols-2 gap-8 justify-around md:my-72 md:py-6 items-center justify-items-center">
        <div className="max-w-sm flex flex-col ">
          <Link href={link}>
            <h2 className="text-2xl text-blue-600 py-4 font-bold ">{title}</h2>
          </Link>
          <p className="text-lg dark:text-white text-black">{description}</p>
        </div>
